    ...
    public class OAuthProviderSetting
    {
        ...
        public OAuth2Authenticator LoginWithProvider(string Provider)
        {
			...
			switch (Provider.ToLower())
            {
                ...
                case "facebook":
                {
					//For Facebook login, for configure refer https://code.msdn.microsoft.com/Register-Identity-Provider-41955544
					auth = new OAuth2Authenticator(
                    clientId: "407367082998596",													
                    scope: "",
                    authorizeUrl: new Uri("https://m.facebook.com/dialog/oauth/"),                  // These values do not need changing
                    redirectUrl: new Uri("http://www.facebook.com/connect/login_success.html")
					//,getUsernameAsync: null, isUsingNativeUI: nativeUI
