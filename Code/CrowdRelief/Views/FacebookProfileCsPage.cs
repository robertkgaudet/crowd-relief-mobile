...
namespace FacebookLogin.Views
{
    public class FacebookProfileCsPage : ContentPage
    {
        ...
        /// </summary>
        private string ClientId = "407367082998596"; //CrowdRelief
        ...
        public FacebookProfileCsPage()
        {
            ...
            var apiRequest = "https://www.facebook.com/dialog/oauth?client_id=" + ClientId + "&display=popup&response_type=token&redirect_uri=http://www.facebook.com/connect/login_success.html";

            var webView = new WebView {Source = apiRequest, HeightRequest = 1};
