    ...
    public class Constants
    {
        public struct ApiInfo
        {
            public struct GoogleInfo
            {
                ...
                public const string GoolgeiOSClientId = "1052811891786-iuui5rc9fmhksm61kedm2dlu9lhs50vg.apps.googleusercontent.com";
                public const string GoogleAuthUrl = "https://accounts.google.com/o/oauth2/auth";
                public const string GoogleRedirectUrl = "com.crowdrelief.droid:/oauth2redirect";
                public const string GoogleTokenUrl = "https://accounts.google.com/o/oauth2/token";
                public const string GoogleScopes = "https://www.googleapis.com/auth/userinfo.profile https://www.googleapis.com/auth/userinfo.email https://www.googleapis.com/auth/plus.login";
